...
- **2026-07-18 (P0, German → 500)** — batch 4: +143 words to reach the **502-word target** (all unique). Numbers 11–20 + tens/hundert/tausend, extended family, clothing, more food, kitchen/household, more body parts, transport, professions, seasons/time, more places, education/communication, more abstract nouns, +18 verbs, +18 adjectives. Added 4 packs (15 Extended Family, 16 Clothes, 17 Getting Around, 18 In the Kitchen). **German COMPLETE for now: 502 words, 19 units A1→B2, 18 packs, 23 grammar lessons.** Felix to spot-check genders.
  - **Next up:** German is done (user's 500 target hit). Next major moves: **ES/FR/RU** vocab+unit expansion via the hermitdave process (conservatively); the re-rank/stable-id migration; and **P1** (LLM graded-reading library — the biggest remaining lever).
- **2026-07-18 (P0, Spanish batch 1)** — started ES/FR/RU. Spanish already had the top function words, so this batch is **+112 CONTENT words** (211 → **323**, all unique): abstract nouns (verdad/muerte/guerra/paz/razón/idea/forma/manera/historia/persona), nature (árbol/flor/sol/luna/cielo/mar/río/montaña/tierra/fuego/piedra), animals, transport (coche/tren/barco/avión), household/clothing, extended family (hijo/hija/hermano/hermana/abuelo/abuela/tío/tía), rey/reina, +verbs (correr/dormir/jugar/cantar/bailar/cocinar/traer/ganar/perder/morir/sentir/recordar/olvidar/cambiar/empezar/terminar/mirar/escuchar/cerrar) and +adjectives (frío/caliente/largo/corto/lleno/vacío/limpio/sucio/rico/pobre/oscuro/claro/duro/seco/mojado/amable/libre/peligroso…). Added 6 packs (10–15). **Note: user can't verify Spanish** — authored genders from knowledge; flagged for later native check.
  - **FSRS status:** NOT wired (still P5, parked). **Re-rank:** recommended defer — bigger than it sounds (position-derived IDs tied to progress; needs per-word frequency matching) for modest payoff (only the "up next" queue); current curated-first order is a fine curriculum.
- **2026-07-18 (P0, French + Russian)** — **French: 82 → 270** (+188): function words (vous/on/qui/quoi/rien/tout/quel + possessives), question words/adverbs/prepositions, ~40 verbs, numbers 4–10 + 20/100/1000, colors, body, food, animals, nature, places, household, clothing, adjectives — +8 packs. **Russian: 87 → 227** (+140, all with romanization): question words, connectors, prepositions, adverbs, possessives, numbers 6–10 + сто/тысяча, +18 verbs, body/food/animals/nature/places/family/household nouns (with gender markers), +18 adjectives — +6 packs. All genders/glosses authored from knowledge — **user can't verify ES/FR/RU; these want a native/reference check.**
  - **Current vocab totals:** DE 502, ES 323, FR 270, RU 227.
- **2026-07-18 (P0, ES/FR/RU teaching units)** — added **13 units** that teach the new vocab with objectives + simple graded readings + examples (kept deliberately simple to limit error surface in unverifiable languages). **Spanish 15→19** (Animals, Nature, Getting Around, More Everyday Verbs). **French 5→10** (Numbers, Colors, The Body, More Food & Drink, Animals & Nature). **Russian 4→8** (Numbers, The Body, Animals & Nature, More Common Verbs). **ES/FR/RU readings authored from knowledge — flagged for native review.**
  - **Course status:** DE 19 units / ES 19 / FR 10 / RU 8. Vocab: DE 502, ES 323, FR 270, RU 227.
  - **Next up:** P1 (LLM graded-reading library — biggest remaining lever) OR a native/reference review pass on all the authored ES/FR/RU content (vocab genders + unit readings). More ES/FR/RU units/vocab also possible. (FSRS parked P5; stable-ID re-rank deferred.)
