...
- **2026-07-18 (P0, French + Russian)** — **French: 82 → 270** (+188): function words (vous/on/qui/quoi/rien/tout/quel + possessives), question words/adverbs/prepositions, ~40 verbs, numbers 4–10 + 20/100/1000, colors, body, food, animals, nature, places, household, clothing, adjectives — +8 packs. **Russian: 87 → 227** (+140, all with romanization): question words, connectors, prepositions, adverbs, possessives, numbers 6–10 + сто/тысяча, +18 verbs, body/food/animals/nature/places/family/household nouns (with gender markers), +18 adjectives — +6 packs. All genders/glosses authored from knowledge — **user can't verify ES/FR/RU; these want a native/reference check.**
  ...
  - **Next up:** teaching UNITS for the new ES/FR/RU words (they're in packs/review but not yet taught in lessons, like German got). Then P1 (LLM graded-reading library — biggest remaining lever), or a native review pass on ES/FR/RU content. (FSRS still parked P5; stable-ID re-rank deferred.)
