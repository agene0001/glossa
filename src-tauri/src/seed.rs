...
fn spanish_units(language: &LanguageCode, base: i64, ids: &HashMap<String, LexemeId>) -> Vec<Unit> {
    ...
    vec![
        ...
        unit(16, "A1.2", "Animals",
            "Name common animals.",
            "Talk about animals, and make nouns plural.",
            &["perro", "gato", "pájaro", "caballo", "vaca", "animal"], Some(5),
            rd("Los animales",
                "En mi casa hay un perro y un gato. En el campo hay un caballo y una vaca. Me gustan los animales.",
                "In my house there is a dog and a cat. In the field there is a horse and a cow. I like animals."),
            vec![
                ex("El perro y el gato.", "The dog and the cat."),
                ex("El caballo es grande.", "The horse is big."),
                ex("Yo veo un pájaro.", "I see a bird."),
                ex("Me gustan los animales.", "I like animals."),
            ]),
        unit(17, "A2", "Nature",
            "Talk about nature.",
            "The natural world.",
            &["árbol", "flor", "sol", "luna", "cielo", "mar", "río", "montaña"], None,
            rd("La naturaleza",
                "El sol está en el cielo. En el río hay agua. La montaña es alta y el mar es grande. Veo un árbol con flores.",
                "The sun is in the sky. In the river there is water. The mountain is tall and the sea is big. I see a tree with flowers."),
            vec![
                ex("El sol y la luna.", "The sun and the moon."),
                ex("El árbol tiene flores.", "The tree has flowers."),
                ex("El mar es grande.", "The sea is big."),
                ex("El río está en la montaña.", "The river is in the mountain."),
            ]),
        unit(18, "A2", "Getting Around",
            "Talk about travel and places.",
            "Transport and places around town.",
            &["coche", "tren", "barco", "avión", "iglesia", "oficina", "universidad", "lugar"], None,
            rd("De viaje",
                "Voy a la universidad en tren. Mi padre trabaja en una oficina. El domingo vamos a la iglesia. Es un lugar bonito.",
                "I go to the university by train. My father works in an office. On Sunday we go to the church. It's a nice place."),
            vec![
                ex("Yo voy en tren.", "I go by train."),
                ex("El coche es nuevo.", "The car is new."),
                ex("La universidad es grande.", "The university is big."),
                ex("Es un buen lugar.", "It's a good place."),
            ]),
        unit(19, "A2", "More Everyday Verbs",
            "Talk about an active day.",
            "More common verbs for daily life.",
            &["correr", "dormir", "jugar", "cantar", "bailar", "cocinar", "mirar", "escuchar"], None,
            rd("Un día activo",
                "Por la mañana corro en el parque. Me gusta cantar y bailar. Por la tarde cocino y escucho música. Por la noche duermo bien.",
                "In the morning I run in the park. I like to sing and dance. In the afternoon I cook and listen to music. At night I sleep well."),
            vec![
                ex("Yo corro en el parque.", "I run in the park."),
                ex("Me gusta cantar.", "I like to sing."),
                ex("Ella cocina la comida.", "She cooks the food."),
                ex("Yo escucho música.", "I listen to music."),
            ]),
    ]
}
...
fn french_units(language: &LanguageCode, base: i64, ids: &HashMap<String, LexemeId>) -> Vec<Unit> {
    ...
    vec![
        ...
        unit(6, "A1.1", "Numbers (Les nombres)",
            "Count from one to ten.",
            "Numbers and counting.",
            &["un", "deux", "trois", "quatre", "cinq", "six", "sept", "huit", "neuf", "dix"], None,
            rd("Compter",
                "Un, deux, trois, quatre, cinq. Six, sept, huit, neuf, dix. J'ai deux chats et trois livres.",
                "One, two, three, four, five. Six, seven, eight, nine, ten. I have two cats and three books."),
            vec![
                ex("Un, deux, trois.", "One, two, three."),
                ex("J'ai deux amis.", "I have two friends."),
                ex("Il y a cinq livres.", "There are five books."),
                ex("Quatre et six.", "Four and six."),
            ]),
        unit(7, "A1.1", "Colors (Les couleurs)",
            "Name colors and describe things by their color.",
            "Name colors to describe things.",
            &["rouge", "bleu", "vert", "noir", "blanc", "jaune", "gris"], Some(1),
            rd("Les couleurs",
                "J'ai un chat noir et un chien blanc. Le ciel est bleu et l'arbre est vert. Ma voiture est rouge.",
                "I have a black cat and a white dog. The sky is blue and the tree is green. My car is red."),
            vec![
                ex("Le chat noir et le chien blanc.", "The black cat and the white dog."),
                ex("Le ciel est bleu.", "The sky is blue."),
                ex("Une fleur rouge.", "A red flower."),
                ex("La voiture est verte.", "The car is green."),
            ]),
        unit(8, "A1.2", "The Body (Le corps)",
            "Name the parts of the body.",
            "Parts of the body, and plurals.",
            &["tête", "main", "œil", "bouche", "nez", "pied", "bras", "jambe", "cœur"], Some(5),
            rd("Le corps",
                "J'ai une tête, deux yeux et une bouche. Avec les mains je joue et avec les pieds je cours. Mon cœur va bien.",
                "I have a head, two eyes and a mouth. With my hands I play and with my feet I run. My heart is fine."),
            vec![
                ex("La tête et la main.", "The head and the hand."),
                ex("J'ai deux yeux.", "I have two eyes."),
                ex("Le bras et la jambe.", "The arm and the leg."),
                ex("Mon cœur va bien.", "My heart is fine."),
            ]),
        unit(9, "A1.2", "More Food & Drink",
            "Talk about more food and put a meal together.",
            "More food and drink, with -er verbs.",
            &["viande", "fromage", "œuf", "fruit", "légume", "poisson", "riz", "soupe", "vin"], Some(2),
            rd("Au restaurant",
                "Je mange de la viande avec des légumes et du riz. Après, je mange un fruit. Mon père boit du vin. La soupe est bonne.",
                "I eat meat with vegetables and rice. Afterwards, I eat a fruit. My father drinks wine. The soup is good."),
            vec![
                ex("Je mange de la viande.", "I eat meat."),
                ex("Le fromage et l'œuf.", "The cheese and the egg."),
                ex("J'aime le poisson.", "I like fish."),
                ex("La soupe est bonne.", "The soup is good."),
            ]),
        unit(10, "A2", "Animals & Nature",
            "Talk about animals and nature.",
            "Animals and the natural world.",
            &["oiseau", "cheval", "vache", "arbre", "fleur", "soleil", "lune", "mer", "montagne"], None,
            rd("La nature",
                "Le soleil est dans le ciel. Sur la montagne, il y a des arbres et des fleurs. Je vois un oiseau, un cheval et une vache.",
                "The sun is in the sky. On the mountain, there are trees and flowers. I see a bird, a horse and a cow."),
            vec![
                ex("Le soleil et la lune.", "The sun and the moon."),
                ex("L'arbre et la fleur.", "The tree and the flower."),
                ex("La mer est grande.", "The sea is big."),
                ex("Je vois un oiseau.", "I see a bird."),
            ]),
    ]
}
...
fn german_units(language: &LanguageCode, base: i64, ids: &HashMap<String, LexemeId>) -> Vec<Unit> {
    ...
    vec![
        ...
        unit(9, "A1.2", "Animals",
            "Name common animals.",
            "Talk about animals, and make nouns plural.",
            &["Hund", "Katze", "Vogel", "Fisch", "Pferd", "Kuh", "Maus", "Tier"], Some(4),
            rd("Auf dem Bauernhof",
                "Auf dem Bauernhof gibt es viele Tiere. Der Hund läuft im Garten. Die Katze schläft. Das Pferd und die Kuh fressen. Ich sehe auch einen Vogel und einen Fisch.",
                "On the farm there are many animals. The dog runs in the garden. The cat sleeps. The horse and the cow eat. I also see a bird and a fish."),
            vec![
                ex("Der Hund und die Katze.", "The dog and the cat."),
                ex("Das Pferd ist groß.", "The horse is big."),
                ex("Ich habe einen Vogel.", "I have a bird."),
                ex("Die Maus ist klein.", "The mouse is small."),
            ]),
        unit(10, "A1.2", "The Body",
            "Name the parts of the body.",
            "Parts of the body — many come in pairs (plurals).",
            &["Kopf", "Hand", "Auge", "Ohr", "Nase", "Mund", "Fuß", "Bein", "Arm", "Herz"], Some(4),
            rd("Der Körper",
                "Ich habe einen Kopf, zwei Augen und einen Mund. Mit den Händen schreibe ich, und mit den Füßen laufe ich. Mein Herz ist gesund.",
                "I have a head, two eyes and a mouth. With my hands I write, and with my feet I run. My heart is healthy."),
            vec![
                ex("Der Kopf und die Hand.", "The head and the hand."),
                ex("Ich habe zwei Augen.", "I have two eyes."),
                ex("Der Arm und das Bein.", "The arm and the leg."),
                ex("Das Herz ist gesund.", "The heart is healthy."),
            ]),
        unit(11, "A2", "Nature & Weather",
            "Talk about nature and the weather.",
            "The natural world and the weather.",
            &["Baum", "Blume", "Sonne", "Mond", "Regen", "Berg", "Meer", "Wald", "Himmel", "Wetter"], None,
            rd("Das Wetter",
                "Heute ist das Wetter schön. Die Sonne scheint am Himmel. Im Wald stehen viele Bäume und Blumen. Morgen kommt der Regen.",
                "Today the weather is nice. The sun shines in the sky. In the forest stand many trees and flowers. Tomorrow the rain comes."),
            vec![
                ex("Die Sonne und der Mond.", "The sun and the moon."),
                ex("Der Baum ist im Wald.", "The tree is in the forest."),
                ex("Das Meer ist groß.", "The sea is big."),
                ex("Heute gibt es Regen.", "Today there is rain."),
            ]),
        unit(12, "A2", "Around Town",
            "Say where you go around town.",
            "Places in town — with two-way prepositions (motion vs location).",
            &["Stadt", "Garten", "Park", "Geschäft", "Restaurant", "Krankenhaus", "Bahnhof", "Kirche", "Wohnung", "Weg"], Some(14),
            rd("Ein Tag in der Stadt",
                "Am Morgen gehe ich in den Park. Dann kaufe ich Brot im Geschäft. Am Mittag esse ich im Restaurant. Am Abend fahre ich vom Bahnhof nach Hause in meine Wohnung.",
                "In the morning I go to the park. Then I buy bread at the shop. At noon I eat at the restaurant. In the evening I go from the station home to my apartment."),
            vec![
                ex("Ich gehe in den Park.", "I go to the park."),
                ex("Das Restaurant ist in der Stadt.", "The restaurant is in the city."),
                ex("Der Bahnhof und die Kirche.", "The train station and the church."),
                ex("Meine Wohnung ist klein.", "My apartment is small."),
            ]),
        unit(13, "A1.2", "More Food & Drink",
            "Talk about more foods and put a meal together.",
            "More food and drink, reinforcing the present tense.",
            &["Fleisch", "Obst", "Gemüse", "Suppe", "Bier", "Wein", "Tee", "Zucker", "Salz"], Some(2),
            rd("Im Restaurant",
                "Zum Mittagessen esse ich Fleisch mit Gemüse. Danach esse ich Obst. Mein Vater trinkt ein Bier und meine Mutter trinkt Tee. Die Suppe braucht Salz.",
                "For lunch I eat meat with vegetables. Afterwards I eat fruit. My father drinks a beer and my mother drinks tea. The soup needs salt."),
            vec![
                ex("Ich esse Fleisch und Gemüse.", "I eat meat and vegetables."),
                ex("Das Obst ist frisch.", "The fruit is fresh."),
                ex("Er trinkt Wein.", "He drinks wine."),
                ex("Die Suppe braucht Salz.", "The soup needs salt."),
            ]),
        unit(14, "A2", "Describing Things",
            "Describe things as hot, cold, cheap, or expensive.",
            "More adjectives to describe the world.",
            &["kalt", "warm", "heiß", "teuer", "billig", "lang", "kurz", "stark", "schwach", "richtig", "falsch"], Some(15),
            rd("Kalt oder warm?",
                "Im Winter ist es kalt und im Sommer ist es warm. Der Kaffee ist heiß. Das große Auto ist teuer, aber das kleine Auto ist billig. Meine Antwort ist richtig.",
                "In winter it's cold and in summer it's warm. The coffee is hot. The big car is expensive, but the small car is cheap. My answer is correct."),
            vec![
                ex("Das Wasser ist kalt.", "The water is cold."),
                ex("Der Kaffee ist heiß.", "The coffee is hot."),
                ex("Das Auto ist teuer.", "The car is expensive."),
                ex("Die Antwort ist richtig.", "The answer is correct."),
            ]),
        unit(15, "A2", "Everyday Verbs",
            "Talk about your daily routine.",
            "More common verbs for daily life, in the present tense.",
            &["schlafen", "laufen", "schreiben", "hören", "warten", "fragen", "antworten", "öffnen", "treffen", "kennen"], Some(2),
            rd("Mein Tag",
                "Am Morgen laufe ich in den Park. Ich treffe einen Freund und wir reden. Ich frage etwas und er antwortet. Am Abend schreibe ich und höre Musik. Dann schlafe ich.",
                "In the morning I run to the park. I meet a friend and we talk. I ask something and he answers. In the evening I write and listen to music. Then I sleep."),
            vec![
                ex("Ich schlafe am Abend.", "I sleep in the evening."),
                ex("Ich treffe einen Freund.", "I meet a friend."),
                ex("Ich frage, und du antwortest.", "I ask, and you answer."),
                ex("Ich höre und warte.", "I listen and wait."),
            ]),
        unit(16, "B1", "Feelings & Opinions",
            "Talk about how you feel and give your opinion.",
            "Emotions and opinions, with reflexive verbs (sich freuen).",
            &["Liebe", "Angst", "Freude", "Gefühl", "Meinung", "traurig", "freuen", "fühlen", "glücklich"], Some(16),
            rd("Wie geht es dir?",
                "Heute fühle ich mich glücklich. Ich freue mich, weil ich meinen Freund treffe. Manchmal habe ich Angst, aber meistens habe ich Freude am Leben. Meiner Meinung nach ist die Liebe das wichtigste Gefühl.",
                "Today I feel happy. I'm glad because I'm meeting my friend. Sometimes I'm afraid, but mostly I have joy in life. In my opinion, love is the most important feeling."),
            vec![
                ex("Ich freue mich.", "I'm glad."),
                ex("Ich habe Angst.", "I'm afraid."),
                ex("Das ist meine Meinung.", "That is my opinion."),
                ex("Die Liebe ist wichtig.", "Love is important."),
            ]),
        unit(17, "B1", "Telling a Story",
            "Tell a short story about something that happened.",
            "Narrate the past with the Perfekt (haben/sein + participle).",
            &["Geschichte", "Traum", "plötzlich", "endlich", "zuerst", "gestern", "passieren"], Some(7),
            rd("Ein seltsamer Traum",
                "Gestern habe ich einen seltsamen Traum gehabt. Zuerst bin ich durch einen Wald gelaufen. Plötzlich habe ich ein großes Tier gesehen. Ich hatte Angst und bin schnell weggelaufen. Endlich bin ich aufgewacht.",
                "Yesterday I had a strange dream. First I walked through a forest. Suddenly I saw a big animal. I was afraid and ran away quickly. Finally I woke up."),
            vec![
                ex("Gestern habe ich einen Traum gehabt.", "Yesterday I had a dream."),
                ex("Plötzlich ist etwas passiert.", "Suddenly something happened."),
                ex("Ich habe eine Geschichte gelesen.", "I read a story."),
                ex("Endlich bin ich zu Hause.", "Finally I'm home."),
            ]),
        unit(18, "B1", "Making Plans",
            "Talk about plans and possibilities for the future.",
            "Wishes and hypotheticals with the subjunctive (würde, hätte, möchte).",
            &["Zukunft", "möglich", "versuchen", "entscheiden", "erwarten", "frei"], Some(18),
            rd("Meine Pläne",
                "In der Zukunft möchte ich viel reisen. Ich versuche, jeden Tag Deutsch zu lernen. Wenn ich mehr Zeit hätte, würde ich auch Musik machen. Ich muss bald entscheiden, was ich studieren will.",
                "In the future I would like to travel a lot. I try to learn German every day. If I had more time, I would also make music. I have to decide soon what I want to study."),
            vec![
                ex("In der Zukunft reise ich.", "In the future I travel."),
                ex("Das ist möglich.", "That is possible."),
                ex("Ich versuche es.", "I try it."),
                ex("Ich muss entscheiden.", "I have to decide."),
            ]),
        unit(19, "B2", "Society & the World",
            "Discuss society and the world in more abstract terms.",
            "Abstract topics with the passive and advanced connectors.",
            &["Gesellschaft", "Regierung", "Krieg", "Frieden", "gefährlich", "möglich", "frei"], Some(19),
            rd("Die Welt heute",
                "In unserer Gesellschaft gibt es viele Probleme. Krieg ist gefährlich, deshalb wünschen sich die Menschen Frieden. Obwohl die Zukunft ungewiss ist, bleiben viele Leute optimistisch. Vieles kann verbessert werden.",
                "In our society there are many problems. War is dangerous, therefore people wish for peace. Although the future is uncertain, many people remain optimistic. Much can be improved."),
            vec![
                ex("Unsere Gesellschaft ist frei.", "Our society is free."),
                ex("Krieg ist gefährlich.", "War is dangerous."),
                ex("Alle wünschen sich Frieden.", "Everyone wishes for peace."),
                ex("Vieles kann verbessert werden.", "Much can be improved."),
            ]),
    ]
}
...
fn german_packs(language: &LanguageCode, base: i64, ids: &HashMap<String, LexemeId>) -> Vec<VocabPack> {
    ...
    vec![
        ...
        pack(13, "❤️", "Feelings & Opinions", "Emotions and expressing yourself.",
            &["Liebe", "Angst", "Freude", "Gefühl", "Meinung", "Traum", "glücklich", "traurig", "wütend", "freuen"]),
...
fn russian_units(language: &LanguageCode, base: i64, ids: &HashMap<String, LexemeId>) -> Vec<Unit> {
    ...
    vec![
        ...
        unit(5, "A1.1", "Numbers",
            "Count from one to ten.",
            "Numbers and counting.",
            &["один", "два", "три", "четыре", "пять", "шесть", "семь", "восемь", "девять", "десять"], None,
            rd("Считаем",
                "Один, два, три, четыре, пять. Шесть, семь, восемь, девять, десять. У меня две кошки.",
                "One, two, three, four, five. Six, seven, eight, nine, ten. I have two cats."),
            vec![
                ex("Один, два, три.", "One, two, three."),
                ex("У меня две кошки.", "I have two cats."),
                ex("Пять и пять.", "Five and five."),
                ex("Это десять.", "This is ten."),
            ]),
        unit(6, "A1.2", "The Body",
            "Name the parts of the body.",
            "Parts of the body.",
            &["голова", "рука", "глаз", "рот", "нос", "нога", "сердце"], None,
            rd("Тело",
                "У меня голова, глаза и рот. Это рука, а это нога. Сердце здесь.",
                "I have a head, eyes and a mouth. This is a hand, and this is a leg. The heart is here."),
            vec![
                ex("Голова и рука.", "The head and the hand."),
                ex("Это глаз.", "This is an eye."),
                ex("Рука и нога.", "The arm and the leg."),
                ex("Сердце здесь.", "The heart is here."),
            ]),
        unit(7, "A2", "Animals & Nature",
            "Talk about animals and nature.",
            "Animals and the natural world.",
            &["птица", "лошадь", "корова", "животное", "дерево", "цветок", "солнце", "луна", "море"], None,
            rd("Природа",
                "Солнце на небе. В лесу деревья и цветы. Я вижу птицу, лошадь и корову.",
                "The sun is in the sky. In the forest there are trees and flowers. I see a bird, a horse and a cow."),
            vec![
                ex("Солнце и луна.", "The sun and the moon."),
                ex("Дерево и цветок.", "The tree and the flower."),
                ex("Море большое.", "The sea is big."),
                ex("Я вижу птицу.", "I see a bird."),
            ]),
        unit(8, "A2", "More Common Verbs",
            "Talk about everyday actions.",
            "More common verbs, in the present tense.",
            &["понимать", "думать", "сказать", "давать", "брать", "помогать", "смотреть", "слушать"], Some(2),
            rd("Каждый день",
                "Я думаю по-русски. Я понимаю немного. Друг помогает мне. Мы смотрим фильм и слушаем музыку.",
                "I think in Russian. I understand a little. A friend helps me. We watch a film and listen to music."),
            vec![
                ex("Я думаю.", "I think."),
                ex("Я понимаю.", "I understand."),
                ex("Друг помогает.", "A friend helps."),
                ex("Мы слушаем музыку.", "We listen to music."),
            ]),
    ]
}
...
fn russian_packs(language: &LanguageCode, base: i64, ids: &HashMap<String, LexemeId>) -> Vec<VocabPack> {
    ...
    vec![
        ...
        pack(6, "🔢", "Numbers", "Count from one to ten.",
            &["один", "два", "три", "четыре", "пять", "шесть", "семь", "восемь", "девять", "десять"]),
        pack(7, "🧍", "The Body", "Parts of the body.",
            &["голова", "рука", "глаз", "рот", "нос", "нога", "сердце"]),
        pack(8, "🌳", "Animals & Nature", "Animals and the natural world.",
            &["птица", "лошадь", "корова", "животное", "дерево", "цветок", "солнце", "луна", "небо", "море", "река", "гора", "лес"]),
        pack(9, "🏙️", "Places & Society", "Places you go and the wider world.",
            &["магазин", "ресторан", "больница", "парк", "страна", "город", "мир", "война", "жизнь", "деньги", "музыка", "язык"]),
        pack(10, "🏠", "Home & Family", "Around the house and more family.",
            &["стул", "кровать", "окно", "комната", "ключ", "брат", "сестра", "сын", "дочь"]),
        pack(11, "🔧", "More Common Verbs", "High-frequency verbs.",
            &["понимать", "думать", "сказать", "спрашивать", "отвечать", "давать", "брать",
              "помогать", "ждать", "слушать", "смотреть", "играть", "начинать", "помнить"]),
    ]
}
